...
```{r}
# FILL ME IN -- replace me with R code, with no number symbol.
x <- c(1,4,1,9)
typeof(x)
x[4]
#x[4]=9

# For instance, I am a comment. You can type out answers to questions as comments.
# (But be sure to have a number symbol on every line, if you type more than one!)
```
